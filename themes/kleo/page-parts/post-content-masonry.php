...
?>
	...
	<div class="post-content animated animate-when-almost-visible el-appear">
		...
		<?php if (!empty($link_url_alt)): ?>
		    <span style="font-size:12px;margin-left:10px;"> <b><a target="_blank" href="<?php the_field('url_alt'); ?>"><?php the_field('produkt'); ?> <?php the_field('fotoservice'); ?> <i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a></b></span>
		...
		<span style="font-size:12px;margin-left:10px;"> <b><a target="_blank" href="<?php the_field('url_alt'); ?>"> <?php the_field('preis_von'); ?><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a></b></span>
		...
		<br><span style="font-size:10px;margin-left:10px;"><?php echo do_shortcode('[field text_desc]'); ?></span>
		...
		<div class="post-header">
			...
			<h3 class="post-title entry-title"> <!-- FZ 7.4.16 <a href="<?php the_permalink();?>"><?php the_title();?></a>--> </h3>
			<?php endif; ?>
