<?php
define( 'KLEO_THEME_VERSION', '4.0.5' );

/* Configuration array */
global $kleo_config;

//Post image sizes for carousels and galleries (changed by FZ)
$kleo_config['post_gallery_img_width'] = 124;
$kleo_config['post_gallery_img_height'] = 70;

//Post image sizes for carousels and galleries (original size)
...
$theme_args = array(
	'required_plugins' => array(
        ...
        array(
				...
				'source'			=> kleo_get_plugin_src( 'js_composer', '4.11.1', false ), // The plugin source
        ...
        array(
				...
				'required'			=> true, // If false, the plugin is only 'recommended' instead of required
				'version'			=> kleo_get_plugin_version( 'revslider', '5.2.4.1', $kleo_rem_plugin_transient ), // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
				'source'			=> kleo_get_plugin_src( 'revslider', '5.2.4.1' ), // The plugin source
				'force_activation'		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
				'force_deactivation'	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
				'external_url'		=> '', // If set, overrides default API URL and points to an external URL
		),
